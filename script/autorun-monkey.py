...
if __name__=="__main__":
    round=5
    Case={'ShareFavoriteVideoTest':5,'ShareEmergencyVideoTest':5,'RequestLiveTest':6,'RequestFavoriteVideoTest':6,'PreviewTest':8,'PlayLoopVideoTest':5,'PlayLocalFavoriteVideoTest':5,'PlayLocalEmergencyVideoTest':5,'PlayFavoriteVideoTest':5,'PlayEmergencyVideoTest':5,'DownloadFavoriteVideoTest':8,'DownloadEmergencyVideoTest':8}
